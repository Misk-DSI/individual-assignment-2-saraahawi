...
# Conclusion
1 - Maybe more information about the grapes used and fermentation process conditions 
such as the concentration of sugar and ripeness and type of grapes used. 

2 - Residual sugars need to have a reference point to which we would understand if their concentration in the wine is a lot or not a lot. 

3- The more alcoholic the wine is the higher is the quality. Many factors contribute to the alcohol content in wine such as, age, ripeness of grapes,  etc. 

4- Add sugar levels in the data as well because it's a feature that consumers like. 